          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-10">
            ...
            <div>
              ...
              <p className="text-zinc-500 mb-6 text-sm leading-relaxed">
                E-Code Software Solutions delivers enterprise-grade applications and cloud
                infrastructure that power businesses worldwide.
              </p>
              ...
              <div className="flex gap-3">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="group w-10 h-10 bg-zinc-900 rounded-lg flex items-center justify-center
                               text-zinc-400 border border-zinc-800 transition-all duration-300
                               hover:bg-zinc-500 hover:text-white
                               hover:shadow-lg hover:shadow-zinc-500/30"
                  >
                ...
                <ul className="space-y-3 text-sm">
                  {links.map((link) => (
                    <li key={link.name}>
                      <Link
                        href={link.href}
                        className="group relative inline-block text-zinc-500 transition-all duration-300 hover:text-zinc-400"
                      >
                        <span className="relative z-10">{link.name}</span>
                        <span className="absolute left-0 -bottom-0.5 h-[2px] w-0 bg-zinc-400 transition-all duration-300 group-hover:w-full" />
                      </Link>
                    </li>
                  ))}
                </ul>
              ...
              <ul className="space-y-4 text-sm">
                ...
                <li>
                  <a
                    ...
                    className="group flex gap-3 text-zinc-500 transition-all duration-300 hover:text-zinc-400"
                  >
                    <MapPin className="w-5 h-5 text-zinc-500 flex-shrink-0 mt-1 transition-transform duration-300 group-hover:-translate-y-0.5 group-hover:scale-110" />
                ...
                <li>
                  <a
                    ...
                    className="group flex gap-3 text-zinc-500 transition-all duration-300 hover:text-zinc-400"
                  >
                    <Phone className="w-5 h-5 text-zinc-500 transition-transform duration-300 group-hover:scale-110" />
                    <span className="transition-transform duration-300 group-hover:translate-x-1">
                      +91 9160006006
                    </span>
                  </a>
                ...
                <li>
                  <a
                    ...
                    className="group flex gap-3 text-zinc-500 transition-all duration-300 hover:text-zinc-400"
                  >
                    <Mail className="w-5 h-5 text-zinc-500 transition-transform duration-300 group-hover:scale-110" />
                    <span className="transition-transform duration-300 group-hover:translate-x-1">
                      info@ecodelearning.com
                    </span>
                  </a>
                </li>
      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            ...
            onClick={scrollToTop}
            className="fixed bottom-8 right-8 w-12 h-12 bg-gradient-to-r from-zinc-600 to-blue-600
                       rounded-full shadow-lg shadow-zinc-500/20 flex items-center justify-center
                       text-white hover:from-zinc-500 hover:to-blue-500 transition-all z-50"
          >
