...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-[90vh] bg-gradient-to-br from-black via-zinc-900 to-black overflow-hidden flex items-center">
      {/* Background */}
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link href="/services">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-zinc-600 text-white hover:bg-zinc-800 px-8 h-14 rounded-xl bg-transparent"
                >
                  View Services
          ...
          >
            <div className="relative">
              ...
              <img
                ...
                alt="Tech"
                className="relative rounded-3xl shadow-2xl w-full max-h-[320px] lg:max-h-none object-cover"
              />
              ...
              <motion.div
                ...
                className="absolute -bottom-6 -left-6 bg-white rounded-2xl p-4 shadow-xl hidden lg:block"
              >
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center">
                    <span className="iconify text-green-600" data-icon="lucide:graduation-cap" data-width="28" />
                  </div>
                  <div>
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center">
                    <span className="iconify text-blue-600" data-icon="lucide:briefcase" data-width="28" />
                  </div>
                  <div>
